     ...
     <div class="row">
        <?php
         if($_SESSION['role_id_sess'] == 002 || $_SESSION['role_id_sess'] == 001 )
         {
             ?>
         <div class="col-sm-2">
             <a class="btn btn-warning" onclick="getModal('setup/user.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create User</a>
         </div>
         <?php
         }
         ?>
