...
?>
   <div class="card">
    <div class="card-header">
        <h5 class="card-title">Splitting List</h5>
    ...
    <div class="card-body">
     <?php
        ...
        {
     ?>
      <a class="btn btn-warning" onclick="getModal('setup/split_setup.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create Split</a>
       <?php
        }
        ?>
