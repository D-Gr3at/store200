...
?>
   <div class="card">
    <div class="card-header">
        <h5 class="card-title">Airline List</h5>
        <h6 class="card-subtitle text-muted">The report contains Airlines that have been setup in the system.</h6>
    </div>
    <div class="card-body">
     <?php
        ...
        {
     ?>
      <a class="btn btn-warning" onclick="getModal('setup/airline_setup.php','modal_div')"  href="javascript:void(0)" data-toggle="modal" data-target="#defaultModalPrimary">Create Airline</a>
       <?php
        }
        ?>
