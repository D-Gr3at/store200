				...
				<div class="col-sm-10 col-md-8 col-lg-6 mx-auto d-table h-100">
					<div class="d-table-cell align-middle">
						...
						<div class="text-center mt-4">
							<h1 class="h2" style="color:#000">Vuvaa Shop</h1>
							<p class="lead">
								Change Password
							</p>
						</div>
							...
							<div class="card-body">
								<div class="m-sm-4">
									<div class="text-center">
										<img src="img/logo.png" alt="Chris Wood" style="max-width:30%"  class="img-responsive" />
									</div>
									<form id="form1">
										<input type="hidden" name="op" value="Users.doPasswordChange_1">
