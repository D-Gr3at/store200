       ...
       <div class="row">
           <div class="col-sm-6">
               <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" name="name" onkeyup="validateCode(this.value)" value="<?php echo $cat[0]['name']; ?>"  class="form-control" />
                </div>
           </div>
           <div class="col-sm-6">
               <div class="form-group">
                    <label class="form-label">Category Description</label>
                    <input type="text" name="description" class="form-control" value="<?php echo $cat[0]['description']; ?>" placeholder="">
                </div>
           </div>
