...
if(isset($_REQUEST['op']) && $_REQUEST['op'] == 'edit')
{
    ...
    $sql_brand = "SELECT * FROM brand WHERE id = '$brand_id' LIMIT 1";
    $brand = $dbobject->db_query($sql_brand);
}else
{
    $operation = 'new';
}
...
<div class="modal-header">
    <h4 class="modal-title" style="font-weight:bold">Brand Setup</h4>
...
<div class="modal-body m-3 ">
    <form id="form1" onsubmit="return false">
       <input type="hidden" name="op" value="Brand.saveBrand">
